...
import com.intuit.driveronboard.exception.FileNotFoundException;
...
public class LocalFileStorageService implements FileStorageService {
    ...
    public String storeFile(MultipartFile file, String fileNamePrefix) {
        // Normalize file name
        String fileName = fileNamePrefix + "_" + StringUtils.cleanPath(Objects.requireNonNull(file.getOriginalFilename()));
        ...
        try {
            ...
            if (!(fileName.contains(".jpg") || fileName.contains(".jpeg") || fileName.contains(".png") || fileName.contains(".pdf"))) {
                throw new FileStorageException("Sorry! File uploaded with invalid extension, only .jpg, .png and .pdf are supported. " + fileName);
            }
    ...
    public Resource loadFileAsResource(String fileName) {
        try {
            ...
            if (resource.exists()) {
                ...
                throw new com.intuit.driveronboard.exception.FileNotFoundException("File not found " + fileName);
            }
